...
with models.DAG(
    ...
    train_model = mlengine_operator.MLEngineTrainingOperator(
        ...
        job_id='{}_{}'.format('census_train_job', str(uuid.uuid4())),
        package_uris='gs://cap-4985-modelmanagement/census/package/census-deploy-package-0.1.tar.gz',
    ...
    #"--jobDir='gs://cap-4985-modelmanagement/wpp/output/'",