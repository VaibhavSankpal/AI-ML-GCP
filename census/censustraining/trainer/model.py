...
#     df = query_job.result().to_dataframe()  # Waits for query to finish
    ...
    df = bqhelper.read_from_bqtable('sb-bigdata-4985-da852265', 'SELECT age, workclass, functional_weight, education, education_num, marital_status, occupation, relationship, race, sex, capital_gain, capital_loss, hours_per_week, native_country, income_bracket FROM `sb-bigdata-4985-da852265.modelmanagement.composer_census_data`')
