...
#     df = query_job.result().to_dataframe()  # Waits for query to finish
    ...
    df = bqhelper.read_from_bqtable('sbx-4985-poc-cio-6c81628f', 'SELECT age, workclass, functional_weight, education, education_num, marital_status, occupation, relationship, race, sex, capital_gain, capital_loss, hours_per_week, native_country, income_bracket FROM `sbx-4985-poc-cio-6c81628f.modelmanagement.census_adult_income`')
